...
# directory
def CaptureImages(directory, camera_type="azure_kinect"):
    ...
    capture_device = DataCaptureDevice(device_type=camera_type)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--capture', default=False, action="store_true", help='capturing the data for manual intrinsic and distortion calibration')
    args = parser.parse_args()
    if args.capture:
        print("Capturing pictures... May override previous captured pictures")
        print("Press Space to capture image")
        CaptureImages("calibration_images", args.camera_type)
        print("Pictures stored to calibration_images/")
    intrinsics, distortion, roi, new_intrinsics = CalibrateCamera('calibration_images',True)
    print(("="*10) + "Intrinsics" + ("="*10))
    print(intrinsics)
    print(("="*10) + "Distortion" + ("="*10))
    print(distortion)
